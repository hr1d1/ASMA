      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav mx-auto">
          ...
          <li class="nav-item px-lg-4">
            <a class="nav-link text-uppercase text-expanded" href="http://localhost/ASMA/ASMA/services.php"> View Services</a>
          </li>
...
<?php
    ...
    $sql="SELECT  price from appointment_view_customer ";
$statement=oci_parse($conn,$sql);
oci_execute($statement);
while ($row=oci_fetch_array($statement))
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Appointment Created</h5>
